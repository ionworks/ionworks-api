...
def plot_simulation_results(
    time_series: dict, title: str = "Simulation Results", verbose: bool = True
) -> None:
    ...
    ----------
    time_series : dict
        Dictionary containing time series data with keys like "Time [s]",
...
def plot_batch_simulation_results(
    simulation_data_list: list[dict],
    ...
    ----------
    simulation_data_list : list[dict]
        List of simulation data dictionaries, each containing a "time_series" key.
    simulation_metadata_list : list[dict]
