...
class UrlsClient:
    ...
    def _project_path(self, suffix: str, project_id: str | None) -> str:
        ...
        prepends the shared ``/projects/{project_id}`` root that
        ...
        return f"{self._app_base_url}/projects/{project_id}{suffix}"
    ...
    def project(self, project_id: str | None = None) -> str:
        ...
        studies page (``/projects/{p}/studies``), so this returns
        that URL.
