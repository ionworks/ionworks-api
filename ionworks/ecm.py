...
class FitResults(BaseModel):
    ...
    capacity_Ah: float | None = Field(
        default=None,
        description=(
            "Cell capacity the fit used to integrate SOC. Persisted on save and "
            "reused when re-simulating for validation."
        ),
    )
...
class ValidationResults(BaseModel):
    ...
    capacity_Ah: float = Field(description="Capacity used for SOC integration [Ah].")
